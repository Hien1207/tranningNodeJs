    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          return _context4.abrupt("return", next(new AppError('There is no user width email address.', 404)));
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 5:
          ...
          return _context6.abrupt("return", next(new AppError('Your current password is wrong.', 400)));
